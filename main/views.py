...
from .models import Announcement, Event, Option, UsefulLink, CarouselItem
...
def bilisim_gunu_view(request):
    bilisim_gunu_text = Option.objects.get(name='bilisim_gunu_text').value

    return render(request, 'pages/bilisim_gunu_page.html', {'bilisim_gunu_text': bilisim_gunu_text})
